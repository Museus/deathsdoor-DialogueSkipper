; Death's Door Dialogue Skipper v1.2.1-rc.1
;
; Authors
; -------
...
Gui, skippingOverlay:Show, y0 x0 NoActivate, DD_SkippingOverlay_v1.2.1.rc.1
...
loop
{
	if WinActive("ahk_exe DeathsDoor.exe")
    {
		...
		if (spamKeyIsDown) {
			ShowSkippingOverlayText("Skipping... (v1.2.1-rc.1)")
